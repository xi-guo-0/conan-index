...
class re2Recipe(ConanFile):
    name = "re2"
    description = "a fast, safe, thread-friendly alternative to backtracking regular expression engines like those used in PCRE, Perl, and Python. It is a C++ library"
    ...
    version = "2024-07-02"
    url = "https://github.com/google/re2/archive/refs/tags/{0}.tar.gz".format(version)
