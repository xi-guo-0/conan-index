...
class spdlogRecipe(ConanFile):
    ...
    version = "v1.15.0"
    url = "https://github.com/gabime/spdlog/archive/refs/tags/{0}.tar.gz".format(version)
    ...
    def configure_cmake(self):
        ...
        variables["SPDLOG_BUILD_SHARED"] = convert_to_cmake_boolean(self.options.shared)
        variables["SPDLOG_BUILD_PIC"] = convert_to_cmake_boolean(self.options.fPIC)
